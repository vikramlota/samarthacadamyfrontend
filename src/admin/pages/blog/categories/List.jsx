    ...
    { key: 'description', label: 'Description', render: r => <span className="line-clamp-1 text-gray-500">{r.description || '—'}</span> },
    {
      ...
      render: r => (
        <div className="flex gap-1.5">
          <button onClick={() => navigate(`/blog/categories/${r._id}`)} className="p-1.5 text-blue-500 hover:text-blue-700"><FaEdit /></button>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="primary" icon={FaPlus} onClick={() => navigate('/blog/categories/new')}>New Category</Button>
      </div>
